...
ECHO VACUUM %%I
ECHO VACUUM %%I>>%~dp0%~n0_logs\!DateNow!\%%I_!DateNow!_!TimeNow!.log
ECHO.
ECHO.>>%~dp0%~n0_logs\!DateNow!\%%I_!DateNow!_!TimeNow!.log

REM VACUUM FULL + VACUUM
"%PGBIN%\vacuumdb.exe" --dbname %%I --full --analyze --echo --verbose 2>>%~dp0%~n0_logs\!DateNow!\%%I_!DateNow!_!TimeNow!.log
...
REM Анализ ошибок
IF NOT !ERRORLEVEL!==0 ECHO VACUUM %%I_!DateNow!_!TimeNow! - Error. !ERRORLEVEL!>>%~dp0%~n0_logs\!DateNow!\ShortLog_!DateNow!.log
IF NOT !ERRORLEVEL!==1 ECHO VACUUM %%I_!DateNow!_!TimeNow! - Successfully completed. !ERRORLEVEL!>>%~dp0%~n0_logs\!DateNow!\ShortLog_!DateNow!.log
