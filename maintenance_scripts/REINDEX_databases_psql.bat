REM ОБСЛУЖИВАНИЕ БАЗ 1С REINDEX
...
ECHO REINDEX %%I
ECHO REINDEX %%I>>%~dp0%~n0_logs\!DateNow!\%%I_!DateNow!_!TimeNow!.log
ECHO.
ECHO.>>%~dp0%~n0_logs\!DateNow!\%%I_!DateNow!_!TimeNow!.log

REM REINDEX
"%PGBIN%\reindexdb.exe" --dbname %%I --echo --verbose 2>>%~dp0%~n0_logs\!DateNow!\%%I_!DateNow!_!TimeNow!.log
...
REM Анализ ошибок
IF NOT !ERRORLEVEL!==0 ECHO REINDEX %%I_!DateNow!_!TimeNow! - Error. !ERRORLEVEL!>>%~dp0%~n0_logs\!DateNow!\ShortLog_!DateNow!.log
IF NOT !ERRORLEVEL!==1 ECHO REINDEX %%I_!DateNow!_!TimeNow! - Successfully completed. !ERRORLEVEL!>>%~dp0%~n0_logs\!DateNow!\ShortLog_!DateNow!.log
